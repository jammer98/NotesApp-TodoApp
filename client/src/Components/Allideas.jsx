            ...
            <div className='px-4 py-4 text-neutral-800'>
             ...
             <div className='flex-1 flex items-center justify-between overflow-y-auto px-10 py-5 min-w-max gap-5'>
              ...
              <div className='flex flex-col items-center h-full w-80 bg-[hsl(209,100%,19%)] rounded-2xl shrink-0'>
               ...
               {/*cards*/}
               <div className='rounded-2xl min-h-24 max-h-96 bg-[hsl(208,100%,97%)] m-4 p-5 flex flex-col justify-between shadow-md shadow-neutral-500 hover:scale-105 transition-all duration-200 cursor-pointer'>
