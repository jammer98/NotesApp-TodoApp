    ...
    <div className='w-full h-screen'>
      <div className='flex items-center'>
        ...
        <div className='w-full h-[90%] bg-black flex justify-center items-center'>
            <div>
                <p className='bg-neutral-700 rounded-3xl py-6 px-5 text-3xl font-["Playfair_Display"] font-semibold text-white tracking-tight'>All Your Ideas will be displayed here </p>
            </div>
        </div>
        </div>
      </div>
