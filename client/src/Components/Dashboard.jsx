...
function Dashboard() {
  ...
  return (
    <div className='w-full h-screen flex'>
      {/* Sidebar */}
      <div className='w-1/6 h-screen flex flex-col justify-between border-r-2 border-neutral-500 px-4'>
        ...
        <button onClick={() => navigate('/User')} className='w-full h-auto flex items-center hover:bg-neutral-200 cursor-pointer'>
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
